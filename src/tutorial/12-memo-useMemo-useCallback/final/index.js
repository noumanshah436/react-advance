...
React.memo:---- To avoid re-render a component if the props we are passing it , are same ( as with BigList component).
...
If the props value do not change , we are not triggerring the re-render.
...
useCallback:--- If this function is not changed, it will not recreat it from the scratch ( in case of re-renderring of thecomponent where it is reside )
...
If this function is not chhanged, it will not recreat it from the scratch
